...
function addStyle() {
    ...
    styleElement.innerHTML = ' a[data-task-click="Badges/openBadgesCatalog"]    {        display:none;    }    .BadgesOwner__root, .BadgesStatusBar__leftSideText, div [class="BadgesStack"]    {        display:none;    }.PostActionStatusBar__rightInner    {        display:none;    }';
