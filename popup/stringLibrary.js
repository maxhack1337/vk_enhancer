const strings = {
    ...
    additionalVKEnhancerFunctions: ['Дополнительные функции VK Enhancer', 'Additional VK Enhancer features', 'Додаткові функції VK Enhancer'],
    additionalFunctionsDescription: ['Данные функции работают только совместно с старым дизайном VK от @notmaxhack', 'These features only work in conjunction with the old VK design from @notmaxhack', 'Ці функції працюють тільки разом зі старим дизайном VK від @notmaxhack'],
	...
	versionNumber: ['Версия 3.11.2 Release', 'v. 3.11.2 Release', 'Версія 3.11.2 Release'],
